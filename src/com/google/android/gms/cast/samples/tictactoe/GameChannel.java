...
public abstract class GameChannel implements Cast.MessageReceivedCallback {
     ...
     */
    public final void join(FireflyApiClient apiClient, String name) {
        try {
            Log.d(TAG, "join: " + name);
     ...
     */
    public final void move(FireflyApiClient apiClient, final int row, final int column) {
     ...
     */
    public final void leave(FireflyApiClient apiClient) {
        try {
            Log.d(TAG, "leave");
            JSONObject payload = new JSONObject();
     ...
     */
    public final void requestBoardLayout(FireflyApiClient apiClient) {
        try {
    ...
    private final void sendMessage(FireflyApiClient apiClient, String message) {
